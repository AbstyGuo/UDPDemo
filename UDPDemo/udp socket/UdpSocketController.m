 ...
 */
-(void)startUdpServer{
    self.udpServer=[[GCDAsyncUdpSocket alloc] initWithDelegate:self delegateQueue:dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_DEFAULT, 0)];
    [self.udpServer setIPv6Enabled:YES];
    [self.udpServer setMaxReceiveIPv6BufferSize:6553556];
//    [self.udpServer setMaxReceiveIPv4BufferSize:65535];
...
-(GCDAsyncUdpSocket *)getUdpClient:(id) classz{
    ...
    if(self.udpClient==nil){
        ...
        [self.udpClient setMaxReceiveIPv4BufferSize:65535];
        [self.udpClient setMaxReceiveIPv6BufferSize:6553555];
